...
<head>
    ...
    @if (Auth::user()->role == 1)
        <title>Tambang Web | Dashboard - Super Admin</title>
    @elseif (Auth::user()->role == 2)
        <title>Tambang Web | Dashboard - Admin</title>
    @elseif (Auth::user()->role == 3)
        <title>Tambang Web | Dashboard - Pool</title>
    @elseif (Auth::user()->role == 4)
        <title>Tambang Web | Dashboard - Kepala Kantor</title>
    @endif
